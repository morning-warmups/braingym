...
![alt text](https://uproxx.files.wordpress.com/2015/06/family-guy-chicken.png?w=650&h=400)

#### Answer Four
1. Man carries Chicken to the other side.
2. Man returns and carries Fox to the other side.
3. Man returns with chicken and carries Corn over to the other side.
4. Man returns and carries Chicken to the other side.
